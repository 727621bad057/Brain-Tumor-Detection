...
class Gui:
    ...
    def __init__(self):
        ...
        WindowLabel = tkinter.Label(self.FirstFrame.getFrames(), text="BRAIN TUMOUR DETECTION", height=1, width=40)
        WindowLabel.place(x=320, y=30)
        WindowLabel.configure(background="White", font=("Comic Sans MS", 19, "bold"))
